...
data class TotemMethod(override val uniqueId: UUID = UUID.randomUUID()): ProtectiveMethod() {
    override val priority: ActivationPriority = ActivationPriority.LOW

    override val assetKey: TranslationKey = TranslationKeys.Method.Protective.TOTEM
