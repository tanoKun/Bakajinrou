...
| `jinrou_gimmick_botanical_merchant` | 植物園の行商人の召喚候補位置（複数可） |
...
既存マップとの互換性のため、`4_tp`、`4_all`、`4_foxOnly` も引き続き読み取れます。新規設定では `jinrou_gimmick_` 接頭辞のタグを使用してください。
