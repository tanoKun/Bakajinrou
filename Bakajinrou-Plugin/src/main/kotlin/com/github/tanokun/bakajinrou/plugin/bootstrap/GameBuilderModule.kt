package com.github.tanokun.bakajinrou.plugin.bootstrap
...
import com.github.tanokun.bakajinrou.plugin.game.scheduler.JinrouGameScheduler
...
class GameBuilderModule(plugin: Plugin) {
    ...
    val participantModule = module {
        scope<GameComponents> {
            ...
            scoped<GameAudienceStore> { (spectators: Set<PlayerId>) ->
                GameAudienceStore(get(), GameAudience(spectators))
            }
            scopedOf(::Attacking)
