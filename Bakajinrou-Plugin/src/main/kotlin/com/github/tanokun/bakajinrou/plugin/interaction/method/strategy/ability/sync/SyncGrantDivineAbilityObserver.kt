...
class SyncGrantDivineAbilityObserver(
...
): SyncGrantInventoryObserver(grantedStrategiesPublisher, mainScope, playerProvider, crafting, logger, MethodAssetKeys.Ability.DIVINE) {
