...
class AddSyncSwordMethodObserver(
...
): GrantSyncInventoryObserver(grantedStrategiesPublisher, mainScope, playerProvider, crafting, logger, MethodAssetKeys.Attack.SWORD) {
