package com.github.tanokun.bakajinrou.plugin.interaction.method.strategy.attack.sync
...
class SyncGrantSwordMethodObserver(
...
): SyncGrantInventoryObserver(grantedStrategiesPublisher, mainScope, playerProvider, crafting, logger, MethodAssetKeys.Attack.SWORD) {
    override fun createItem(player: Player, add: MethodDifference.Granted): ItemStack =
        createBasicItem(Material.DIAMOND_SWORD,
            isGlowing = true,
            isVisible = true,
