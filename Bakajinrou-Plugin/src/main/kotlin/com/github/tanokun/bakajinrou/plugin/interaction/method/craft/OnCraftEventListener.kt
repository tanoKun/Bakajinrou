package com.github.tanokun.bakajinrou.plugin.interaction.method.craft
...
class OnCraftEventListener(
    plugin: Plugin, game: JinrouGame, crafting: Crafting, mainScope: CoroutineScope
    ...
    register<CraftItemEvent> { event ->
        val crafter = game.getParticipant(event.whoClicked.uniqueId.asParticipantId()) ?: return@register
