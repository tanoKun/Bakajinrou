...
class FortuneBookItem(
    private val ability: FortuneUsableAbility,
    ...
    override fun createBukkitItem(): ItemStack {
        ...
        item.editMeta { meta ->
            meta.displayName(component { text("占いの本") color Positions.Fortune.color.toString() without italic with bold })
