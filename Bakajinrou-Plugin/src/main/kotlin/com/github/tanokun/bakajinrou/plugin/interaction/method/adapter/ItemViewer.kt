...
import com.github.tanokun.bakajinrou.plugin.interaction.method.adapter.ItemPersistent.IS_TRANSPORTABLE
import com.github.tanokun.bakajinrou.plugin.interaction.method.adapter.ItemPersistent.IS_VISIBLE
import com.github.tanokun.bakajinrou.plugin.interaction.method.adapter.ItemPersistent.JINROU_ITEM_MAKER
import com.github.tanokun.bakajinrou.plugin.interaction.method.adapter.ItemPersistent.setMetadata
...
object ItemViewer {
    ...
    fun ItemStack.hasPossibilityOfMethod(): Boolean = this.persistentDataContainer.has(JINROU_ITEM_MAKER)

    fun ItemStack.isVisible(): Boolean = this.persistentDataContainer.getOrDefault(IS_VISIBLE, PersistentDataType.BOOLEAN, true)

    fun ItemStack.isTransportable(): Boolean = this.persistentDataContainer.getOrDefault(IS_TRANSPORTABLE, PersistentDataType.BOOLEAN, true)
}