...
class SyncGrantDamagePotionMethodObserver(
...
): SyncGrantInventoryObserver(grantedStrategiesPublisher, mainScope, playerProvider, crafting, logger, MethodAssetKeys.Attack.DAMAGE_POTION) {
